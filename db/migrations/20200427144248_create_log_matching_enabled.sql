...
CREATE INDEX log_matching_enabled_header_index
    ON oasis.log_matching_enabled (header_id);
CREATE INDEX log_matching_enabled_log_index
    ON oasis.log_matching_enabled (log_id);
CREATE INDEX log_matching_enabled_address_index
    ON oasis.log_matching_enabled (address_id);

-- +goose Down
DROP TABLE oasis.log_matching_enabled;