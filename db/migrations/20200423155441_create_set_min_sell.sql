...
CREATE INDEX set_min_sell_header_index
    ON oasis.set_min_sell (header_id);
CREATE INDEX set_min_sell_log_index
    ON oasis.set_min_sell (log_id);
CREATE INDEX set_min_sell_address_index
    ON oasis.set_min_sell (address_id);
CREATE INDEX set_min_sell_pay_gem_index
    ON oasis.set_min_sell (pay_gem);
CREATE INDEX set_min_sell_msg_sender
    ON oasis.set_min_sell (msg_sender);

-- +goose Down
DROP TABLE oasis.set_min_sell;
